...
public class PopulationManager2 : MonoBehaviour
{
    ...
    void BreedNewPopulation()
    {
        ...
        List<GameObject> sortedList = population.OrderBy(o => o.GetComponent<Brain2>().timeAlive
            + o.GetComponent<Brain2>().timeWalking * 5).ThenByDescending(x => x.GetComponent<Brain2>().distanceToClosestBro).ToList();
        population.Clear();
